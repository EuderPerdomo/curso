...
<div class="border"><!--Inicia seccion de Contenido -->
  <div class="title text-center border"> <h1 class="font-weight-bold">Inversores OFF GRID</h1></div>
</div>
...
<div class="row">
  ...
  <div class="col-12 col-sm-12 col-md-4">
      <a class="btn rounded-pill btn-block bg-transparent text-center border" role="button" id="botonzoom" href="{{asset('inversor_tema2.4') }}">< Anterior</a>
  </div>
  <div class="col-12 col-sm-12 col-md-4 ">
  ...
  <div class="col-12 col-sm-12 col-md-4 ">
    <a class="btn rounded-pill btn-block bg-transparent text-center border" role="button" id="botonzoom" href="{{asset('inversor_tema2.6') }}">Siguiente ></a>
  </div>
</div>   
  </div>
