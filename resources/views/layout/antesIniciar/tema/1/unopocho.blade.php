...
<div class="row">
  ...
  <div class="col-12 col-sm-12 col-md-4">
      <a class="btn rounded-pill btn-block bg-transparent text-center border" role="button" id="botonzoom" href="{{asset('antesIniciar_tema1.7') }}">< Anterior</a>
  </div>
  <div class="col-12 col-sm-12 col-md-4 ">
  ...
  <div class="col-12 col-sm-12 col-md-4 ">
    <a class="btn rounded-pill btn-block bg-transparent text-center border" role="button" id="botonzoom" href="{{asset('antesIniciar_tema1.9') }}">Siguiente ></a>
  </div>
