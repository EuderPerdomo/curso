...
<div class="col-12 col-sm-12 col-md-6 ">
  ...
  <!--<h7>Imagen De referencia, tomada de: <a href="#m">www.link.co</a></h7> -->
    ...
    <div class="desarolloTema col-12 col-sm-12 col-md-6 text-justify overflow-auto"> 
            <center><h3>Voltaje nominal</h3></center>
...
<div class="row">
  ...
  <div class="col-12 col-sm-12 col-md-4">
      <a class="btn rounded-pill btn-block bg-transparent text-center border" role="button" id="botonzoom" href="{{asset('panel_tema5.1') }}">< Anterior</a>
  </div>
  <div class="col-12 col-sm-12 col-md-4 ">
  ...
  <div class="col-12 col-sm-12 col-md-4 ">
    <a class="btn rounded-pill btn-block bg-transparent text-center border" role="button" id="botonzoom" href="{{asset('panel_tema5.3') }}">Siguiente ></a>
  </div>
</div>   
  </div>
